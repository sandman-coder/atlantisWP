...
function atlantis_customize_preview_js() {
	wp_enqueue_script( 'atlantis-customizer', get_template_directory_uri() . '/dist/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
